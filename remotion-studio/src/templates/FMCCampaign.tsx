...
// ── SVG Heart Logo ────────────────────────────────────────────────────────────
// Real logo image extracted from conversation assets
const LOGO_SRC = staticFile("images/fmc-logo.webp");

const FMCLogo: React.FC<{ size?: number }> = ({ size = 180 }) => (
  <div style={{ width: size, height: size * 1.22, position: "relative" }}>
    {/* White pill behind logo so it reads on dark backgrounds */}
    <div style={{
